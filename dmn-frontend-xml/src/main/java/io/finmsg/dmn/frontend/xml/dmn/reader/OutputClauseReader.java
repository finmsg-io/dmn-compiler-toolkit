...
public final class OutputClauseReader {
	...
	private final ExpressionNodeReader expressionReader = ReaderRegistry.shared().expressionNodeReader();
		...
		if (cursor.firstChild()) {
			do {
				switch (cursor.documentLocalName()) {
					...
					case "defaultOutputEntry" -> builder.setDefaultOutputEntry(expressionReader.read(cursor));
