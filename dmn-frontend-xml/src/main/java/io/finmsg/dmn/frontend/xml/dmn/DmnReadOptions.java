...
public record DmnReadOptions(long maxInputBytes, String systemId, boolean captureSourceLocations, int maxElementDepth) {
	...
	public static DmnReadOptions defaults() {
		return new DmnReadOptions(DEFAULT_MAX_INPUT_BYTES, "", false, DEFAULT_MAX_ELEMENT_DEPTH);
	}
