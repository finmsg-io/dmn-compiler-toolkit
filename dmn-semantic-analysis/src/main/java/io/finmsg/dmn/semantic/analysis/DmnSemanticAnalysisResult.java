...
public record DmnSemanticAnalysisResult(Definitions model, List<DmnSemanticDiagnostic> diagnostics,
	...
	public DmnSemanticAnalysisResult(Definitions model, List<DmnSemanticDiagnostic> diagnostics) {
