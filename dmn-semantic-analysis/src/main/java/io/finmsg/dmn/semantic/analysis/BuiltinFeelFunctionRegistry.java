...
public final class BuiltinFeelFunctionRegistry implements FeelFunctionRegistry {
  ...
  private final Map<String, List<FeelFunctionSignature>> signatures = Map.ofEntries(
      ...
      entry("years and months duration", signature("years and months duration", YEARS_MONTHS_DURATION, DATE_TIME, DATE_TIME)),
      ...
      entry("substring", List.of(
          signature("substring", STRING, STRING, NUMBER),
      ...
      entry("floor", signature("floor", NUMBER, NUMBER)),
      entry("ceiling", signature("ceiling", NUMBER, NUMBER)),
      ...
      entry("sublist", List.of(
          signature("sublist", LIST_ANY, LIST_ANY, NUMBER),
