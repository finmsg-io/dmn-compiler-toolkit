 ...
 */
public record FeelTypeEnvironment(Map<String, TypeReference> symbols, Map<String, ItemDefinition> itemDefinitions,
	...
	public FeelTypeEnvironment {
		...
		decisionTables = decisionTables.entrySet().stream().collect(java.util.stream.Collectors
				.toUnmodifiableMap(Map.Entry::getKey, entry -> java.util.List.copyOf(entry.getValue())));
	}

	public FeelTypeEnvironment(Map<String, TypeReference> symbols, Map<String, ItemDefinition> itemDefinitions) {
