...
public record DmnSemanticPipelineResult(Definitions model, List<DrgElement> compilationOrder,
		List<DmnSemanticDiagnostic> diagnostics, List<DmnSymbolBinding> bindings) {
	...
	public DmnSemanticPipelineResult(Definitions model, List<DrgElement> compilationOrder,
