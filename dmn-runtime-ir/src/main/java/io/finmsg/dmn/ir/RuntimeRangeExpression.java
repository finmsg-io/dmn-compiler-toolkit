...
public record RuntimeRangeExpression(Optional<RuntimeExpression> lower, Optional<RuntimeExpression> upper,
		RuntimeRangeBoundary lowerBoundary, RuntimeRangeBoundary upperBoundary,
