...
final class RuntimeExpressionLowerer {
  ...
  static RuntimeExpression lowerExpression(
  ...
  static RuntimeInvocationExpression lowerInvocation(
  ...
  static RuntimeForExpression lowerFor(
      ForExpression value,
      RuntimeType type,
      String path,
      List<io.finmsg.dmn.semantic.analysis.DmnSymbolBinding> bindings,
  ...
  static RuntimeQuantifiedExpression lowerQuantified(
  ...
  static RuntimeFunctionDefinition lowerFunctionDefinition(
  ...
  static RuntimeRangeExpression lowerRange(
  ...
  static RuntimeUnaryTests lowerUnaryTests(
