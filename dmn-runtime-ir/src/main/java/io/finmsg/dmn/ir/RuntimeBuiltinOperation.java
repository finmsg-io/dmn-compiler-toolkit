...
public enum RuntimeBuiltinOperation {
  ...
  MAX(10, "max"),
  ABS(11, "abs"),
  SUBSTRING(12, "substring"),
  SUBSTRING_BEFORE(13, "substring before"),
  SUBSTRING_AFTER(14, "substring after"),
  STRING_LENGTH(15, "string length"),
  UPPER_CASE(16, "upper case"),
  LOWER_CASE(17, "lower case"),
  CONTAINS(18, "contains"),
  STARTS_WITH(19, "starts with"),
  ENDS_WITH(20, "ends with"),
  MATCHES(21, "matches"),
  REPLACE(22, "replace"),
  SPLIT(23, "split"),
  FLOOR(24, "floor"),
  CEILING(25, "ceiling"),
  DECIMAL(26, "decimal"),
  ROUND_HALF_UP(27, "round half up"),
  ROUND_HALF_EVEN(28, "round half even"),
  SUBLIST(29, "sublist"),
  CONCATENATE(30, "concatenate"),
  DISTINCT_VALUES(31, "distinct values"),
  FLATTEN(32, "flatten"),
  REVERSE(33, "reverse"),
