...
public record RuntimeBkm(int id, int resultSlot, RuntimeType type, List<Integer> dependencies,
		RuntimeFunctionKind functionKind, Optional<RuntimeFunctionDefinition> function) {
	public RuntimeBkm {
	...
	public RuntimeBkm(int id, int resultSlot, RuntimeType type, List<Integer> dependencies) {
