...
public record RuntimeType(RuntimeTypeKind kind, RuntimeType elementType, List<RuntimeType> fields,
		List<RuntimeField> fieldLayout, List<RuntimeType> parameterTypes, RuntimeType returnType) {
	...
	public RuntimeType(RuntimeTypeKind kind, RuntimeType elementType, List<RuntimeType> fields,
			List<RuntimeType> parameterTypes, RuntimeType returnType) {
	...
	public static RuntimeType element(RuntimeTypeKind kind, RuntimeType elementType) {
		return new RuntimeType(kind, Objects.requireNonNull(elementType), List.of(), List.of(), List.of(), null);
	}
	...
	public static RuntimeType contextFields(List<RuntimeField> fields) {
		...
		return new RuntimeType(RuntimeTypeKind.CONTEXT, null, layout.stream().map(RuntimeField::type).toList(), layout,
				List.of(), null);
	}
