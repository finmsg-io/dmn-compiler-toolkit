 ...
 */
public record DmnImportRequest(DmnSourceId importer, String location, String namespace, String modelName) {
	...
	public DmnImportRequest {
		...
		if (location.isEmpty() && namespace.isEmpty() && modelName.isEmpty()) {
			throw new IllegalArgumentException("An import request requires a location, namespace, or model name");
		}
	}
