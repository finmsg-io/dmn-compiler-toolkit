...
public record DmnCompilationResult(
  ...
  public Optional<DmnCompiledModel> compiledModel() {
    ...
    return Optional.of(new DmnCompiledModel(
        namespace, modelName, optimized, inputSlots, decisionSlots, inputTypes, decisionTypes));
  }
}
