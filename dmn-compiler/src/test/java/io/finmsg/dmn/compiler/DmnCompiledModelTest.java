...
class DmnCompiledModelTest {
  ...
  void supportsConcurrentEvaluationAcrossThreads() throws Exception {
    ...
    Map<String, Object> lowRiskInputs = Map.of(
        "RequestedAmount", new BigDecimal("10000"),
        "Applicant", Map.of(
            "score", new BigDecimal("750"),
            "income", new BigDecimal("50000"),
    ...
    Map<String, Object> highRiskInputs = Map.of(
        "RequestedAmount", new BigDecimal("10000"),
        "Applicant", Map.of(
            "score", new BigDecimal("550"),
            "income", new BigDecimal("50000"),
            "monthlyDebt", new BigDecimal("1000")
        )
    );
    ...
    try {
      CompletableFuture<Object> task1 = CompletableFuture.supplyAsync(
          () -> compiledModel.evaluateDecision("LoanApproval", lowRiskInputs), executor);
      CompletableFuture<Object> task2 = CompletableFuture.supplyAsync(
          () -> compiledModel.evaluateDecision("LoanApproval", highRiskInputs), executor);
      CompletableFuture<Object> task3 = CompletableFuture.supplyAsync(
          () -> compiledModel.evaluateDecision("LoanApproval", lowRiskInputs), executor);
      CompletableFuture<Object> task4 = CompletableFuture.supplyAsync(
          () -> compiledModel.evaluateDecision("LoanApproval", highRiskInputs), executor);
