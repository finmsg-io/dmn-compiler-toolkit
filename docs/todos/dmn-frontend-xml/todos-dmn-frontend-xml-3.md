...
2. [ ] Make unsupported-content diagnostics consistent across every reader.
3. [ ] Complete the multi-version, conformance, namespace-shadowing, and security matrix.
...
The next code task is consistent unsupported-content diagnostics. Runtime IR expression lowering
