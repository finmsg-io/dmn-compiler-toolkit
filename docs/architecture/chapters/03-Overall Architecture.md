...
Parsed Model                implemented
   │
   ▼
Semantic Analysis           initial name-resolution pass implemented
   │
   ▼
Optimization                future
   │
...
| Semantic analyzer | parsed `Definitions` | model plus semantic diagnostics | Initial name/property resolution implemented |
...
- complete decision-table validation
- import linking
