...
static/dynamic invocation, and descendant access are implemented. Decision-table and remaining
boxed-logic lowering, constant pools, and model-set lowering remain future work.
